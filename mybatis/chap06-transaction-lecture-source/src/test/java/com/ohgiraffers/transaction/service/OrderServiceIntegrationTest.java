...
class OrderServiceIntegrationTest {
    ...
    public void testRegisterOrder(){
        ...
        orderDTO.setOrderDate("20250327");
        ...
        // then
        Integer orderCount = jdbcTemplate.queryForObject("SELECT COUNT(*) FROM tbl_order", Integer.class);

        Integer orderMenuCount = jdbcTemplate.queryForObject("SELECT COUNT(*) FROM tbl_order_menu", Integer.class);

        assertThat(orderCount).isEqualTo(1);
        assertThat(orderMenuCount).isEqualTo(2);

        String orderDate = jdbcTemplate.queryForObject("SELECT order_date FROM tbl_order", String.class);
